...
public partial class @PlayerControls: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayerControls()
    {
        ...
        UnityEngine.Debug.Assert(!m_Shoot.enabled, "This will cause a leak and performance issues, PlayerControls.Shoot.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_FireLaser.enabled, "This will cause a leak and performance issues, PlayerControls.FireLaser.Disable() has not been called.");
        ...
        UnityEngine.Debug.Assert(!m_Zoom.enabled, "This will cause a leak and performance issues, PlayerControls.Zoom.Disable() has not been called.");
    }
    ...
    {
        private @PlayerControls m_Wrapper;
        public ZoomActions(@PlayerControls wrapper) { m_Wrapper = wrapper; }
